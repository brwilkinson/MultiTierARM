...
Param(
    [string] [Parameter()] $ResourceGroupLocation = "EastUS",
    [string] $ResourceGroupName,
    [switch] $UploadArtifacts,
    [string] $StorageAccountName = 'saeastus01',
    [string] $StorageAccountResourceGroupName = 'rgGlobal', 
...
if ($UploadArtifacts) {
    ...
    $StorageAccountContext = (Get-AzureRmStorageAccount -ResourceGroupName $StorageAccountResourceGroupName -Name $StorageAccountName)[0].Context
